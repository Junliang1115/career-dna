...
export const fieldEdges: FieldEdge[] = [
  ...
  { source: 'blockchain',    target: 'systems',            skill: 'Smart Contracts', strength: 2 },
  { source: 'techsales',     target: 'ux',                 skill: 'Solutions',      strength: 2 },
  { source: 'techconsult',   target: 'fullstack',          skill: 'Consulting',     strength: 2 },
